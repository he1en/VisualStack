...
CREATE TABLE StackFrame(StepNum INT, StepINum INT, LineNum REFERENCES Code(LineNum), LineContents TEXT, MemAddr TEXT REFERENCES Assembly(MemAddr), FrameTop TEXT, UNIQUE(StepNum, StepINum));
