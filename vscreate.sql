...
CREATE TABLE StackFrame(StepNum INT PRIMARY KEY, LineNum REFERENCES Code(LineNum), LineContents TEXT, RSP TEXT, RBP TEXT, RAX TEXT, RBX TEXT, RCX TEXT, RDX TEXT, RSI TEXT, RDI TEXT, R8 TEXT, R9 TEXT, R10 TEXT, R11 TEXT, R12 TEXT, R13 TEXT, R14 TEXT, R15 TEXT);
